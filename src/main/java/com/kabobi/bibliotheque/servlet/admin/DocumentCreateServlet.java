...
@WebServlet("/admin/documents/create")
public class DocumentCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/admin/documents/create.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/documents/create?type=" + type);
        }
    }
