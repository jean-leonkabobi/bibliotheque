...
@WebServlet("/librarian/members/*/activate")
public class MemberActivateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Le bibliothécaire ne peut réactiver que des MEMBERS
            ...
            if (success) {
                ...
                session.setAttribute("error", "Erreur lors de la réactivation du membre");
            }
