...
<head>
    ...
    <title>Ajouter un ouvrage - Administration</title>
    ...
    <main class="main-content">
        ...
        <div class="content">
            ...
            <div class="type-selector">
                <a href="${pageContext.request.contextPath}/admin/documents/create?type=BOOK"
                   class="type-btn ${type eq 'BOOK' ? 'active' : ''}">
                    <i class="fas fa-book type-icon"></i>
                    <strong>Livre</strong>
                    <small>Romans, essais, BD...</small>
                </a>
                <a href="${pageContext.request.contextPath}/admin/documents/create?type=CD"
                   class="type-btn ${type eq 'CD' ? 'active' : ''}">
                    <i class="fas fa-compact-disc type-icon"></i>
                    <strong>CD</strong>
                    <small>Musique, audio...</small>
                </a>
                <a href="${pageContext.request.contextPath}/admin/documents/create?type=DVD"
            ...
            <form action="${pageContext.request.contextPath}/admin/documents/create" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <small>Quantité disponible en stock</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/documents" class="btn-secondary"><i class="fas fa-times"></i> Annuler</a>
                </div>
            </form>
        </div>
    </main>
